...
import static algorithms.SortRectangles.colorRect;
...
//        this.numBars = _numBars;
    ...
    public void sort() {
        ...
        this.transitions.add(colorRect(findBranch(this.rectArr, this.rectArr.length), Color.CORNFLOWERBLUE, this.duration));
        ...
        for (int i = this.rectArr.length-1; i >= 0; i--) {
            ...
            this.transitions.add(colorRect(this.rectArr, Color.CORNFLOWERBLUE, 0));
            this.transitions.add(swapRects(this.rectArr, 0, i, this.duration));
            this.transitions.add(colorRect(this.rectArr, Color.CORNFLOWERBLUE, this.duration, i));
            this.transitions.add(colorRect(findBranch(this.rectArr, i), Color.CORNFLOWERBLUE, this.duration));
